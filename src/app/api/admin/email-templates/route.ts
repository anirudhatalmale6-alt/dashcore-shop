...
function loadTemplates(): AllEmailTemplates {
  try {
    if (existsSync(TEMPLATES_FILE)) {
      ...
      return {
        order_placed: { ...defaults.order_placed, ...parsed.order_placed },
        account_created: { ...defaults.account_created, ...parsed.account_created },
        order_confirmed: { ...defaults.order_confirmed, ...parsed.order_confirmed },
        cms_ready: { ...defaults.cms_ready, ...parsed.cms_ready },
      };
    }
  } catch (err) {
